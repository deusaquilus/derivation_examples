...
object DerivedUsingUnion {
  ...
  trait WriteToMap[T]:
    def writeToMap(mapOrReturn: mutable.Map[String, Any] | JustReturn)(key: String, value: T): Any
  ...
  object WriteToMap {
    ...
    given writeInt: WriteToMap[Int] with
      def writeToMap(mapOrReturn: mutable.Map[String, Any] | JustReturn)(key: String, value: Int): Any = 
        mapOrReturn match
          case _: JustReturn => value
          case map: mutable.Map[String, Any] => map.put(key, value); map

    given writeString: WriteToMap[String] with
      def writeToMap(mapOrReturn: mutable.Map[String, Any]| JustReturn)(key: String, value: String): Any =
        mapOrReturn match
          case _: JustReturn => value
          case map: mutable.Map[String, Any] => map.put(key, value); map
